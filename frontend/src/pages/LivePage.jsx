    ...
    <div className="max-w-4xl mx-auto border-l border-r border-gray-700 min-h-full">
      ...
      <form onSubmit={handleCreate} className="flex gap-2 p-4 border-b border-gray-700">
        ...
        <button
          type="submit"
          disabled={creating}
          className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 text-sm font-semibold hover:opacity-90 disabled:opacity-50"
        >
